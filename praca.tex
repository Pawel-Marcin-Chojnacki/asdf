...
\begin{description}[style=nextline]
	...
	\item[Giełda Papierów Wartościowych] Właściwie ,,Giełda Papierów Wartościowych w Warszawie SA''. Jest to instytucja publiczna zapewniająca możliwość obrót giełdowy papierami wartościowymi. Pozwala na kupno i sprzedaż papierów wartościowych takich jak akcje, obligacje.
	...
	\item[Instrument finansowy] Jest to forma umowy między dwiema stronami, w wyniku której jedna strona posiada aktywa finansowe (składowane u drugiej strony), a druga posiada zobowiązania finansowe (wobec strony pierwszej). Przykładami instrumentów finansowych są papiery wartościowe.
