...
Ekran znajduje~się pod przyciskiem \textit{Dodaj filtr} z~ikoną znaku plus na~stronie głównej aplikacji. Służy on do~określania parametrów aukcji jakie odpowiadają wymaganiom użytkownika. Po~wpisaniu nazwy filtru i~określeniu  które są~zapisywane w~pamięci telefonu celem powtórnego użycia. Po wpisaniu kryteriów użytkownik może zapisać je na telefonie. Filtry są~sposobem na~oszczędzenie czasu, ponieważ pozwalają zapamiętać preferencje użytkownika, są~również niezbędne do~działania powiadomień w~tle, gdzie należy wybrać jeden z~filtrów jako monitor aukcji.

\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{addFilterScreen1.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
\hspace*{60px}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{addFilterScreen2.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{addFilterScreen3.png}
...
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{searchScreen1.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
\hspace*{60px}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{searchScreen2.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
	\hfill
\end{figure}
...
\begin{figure}[h]
	\begin{minipage}[h]{\textwidth}
		\centering
		\includegraphics[width=0.3\textwidth]{searchResultScreen.png}
...
Na tym ekranie dostępne są zdefiniowane przez użytkownika filtry. Pozwalają one na szybki dostęp do aukcji.

\begin{figure}[h]
	\begin{minipage}[h]{\textwidth}
		\centering
		\includegraphics[width=0.3\textwidth]{filtersListScreen.png}
...
Ekran oznaczony na stronie głównej ikoną zębatki. Pozwala na sprawdzenie poprawności pobranego klucza dostępu do serwisu, datę ważności klucza oraz zawiera funkcjonalność monitora aukcji. 
...
\begin{figure}[h]
	\begin{minipage}[h]{\textwidth}
		\centering
		\includegraphics[width=0.3\textwidth]{settingsScreen.png}
...
Na tym ekranie wyświetlane są statystyki spłacalności z poprzedniego miesiąca, prognoza przyszłych zysków, aktualne saldo oraz liczba pożyczek w toku.

\begin{figure}[h]
	\begin{minipage}[h]{\textwidth}
		\centering
		\includegraphics[width=0.3\textwidth]{investorReportScreen.png}
...
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen1.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
\hspace*{60px}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen2.png}
		\caption{Ekran dodawania filtrów}
	\end{minipage}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen3.png}
		\caption{Potwierdzenie zapisania filtru}
	\end{minipage}
		\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen4.png}
		\caption{Potwierdzenie zapisania filtru}
	\end{minipage}
		\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen5.png}
		\caption{Potwierdzenie zapisania filtru}
	\end{minipage}
		\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{auctionDetailsScreen6.png}
		\caption{Potwierdzenie zapisania filtru}
	\end{minipage}
	\hfill
\end{figure}
