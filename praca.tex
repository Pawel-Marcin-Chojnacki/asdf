...
\marginparwidth 0pt
\marginparsep 0pt
% wymiary wzięte z http://www.kulturoznawstwo.uni.wroc.pl/?page_id=5741
\usepackage[top=2.5cm,bottom=3cm,inner=3.5cm,outer=2.5cm]{geometry}
...
\newgeometry{top=3cm,bottom=3cm,inner=3.5cm,outer=2.5cm}
\begin{center}
\begin{large}
