...
\textit{W odniesieniu do zmian wprowadzonych przez Microsoft w 2016 roku w związku z wprowadzeniem nowego podziału architektury .NET, ograniczam się do Standardowej Biblioteki .NET (ang. .NET Standard Library) oraz do .NET Framework ograniczony do podzbioru WPF.\cite{dotnetArtykuł} 
...
\bibitem{dotnetArtykuł} Komponenty architektury zestawu narzędzi .NET, \\
