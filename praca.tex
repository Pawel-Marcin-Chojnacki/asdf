...
\begin{description}[style=nextline]
	...
	\item[Giełda Papierów Wartościowych] Właściwie ,,Giełda Papierów Wartościowych w Warszawie SA''. Jest to instytucja publiczna zapewniająca możliwość obrót giełdowy papierami wartościowymi. Pozwala na kupno i sprzedaż papierów wartościowy takich jak akcje, obligacje.
	\item[Inteligencja finansowa] Pojęcie nie zdefiniowane w słownikach, jednak szeroko używane w ,,poradnikach'' finansowych, blogach czy książkach nt. rozwoju osobistego. Oznacza sprawne posługiwanie się finansami, zrozumienie podstawowych zasad matematyki, tj. procent, procent składany, porównywanie liczb czy obliczanie wartości prostych szerów, ciągów. Zbiór umiejętności tak oczywisty dla matematyków, że nie wpadli by nazwać go ,,inteligencją''.
	\item[Instrument finansowy] Jest to forma umowy między dwoma stronami, w wyniku takiej umowy jedna strona posiada aktywa finansowe (składowane u drugiej strony), druga posiada zobowiązania finansowe (wobec strony pierwszej). Np. papiery wartościowe.
	...
	\item[Oferta inwestycyjna] Propozycja części wkładu pieniężnego przez jednego z pożyczkodawców, najczęściej na warunkach wcześniej określonych przez drugą stronę umowy. Dlatego bardziej jest to akceptacja warunków zawartych w aukcji pożyczkowej.
	...
	\item[RRSO \textit{(Rzeczywista roczna stopa oprocentowania)}] Wszystkie koszty realnie ponoszone przez pożyczkobiorcę. Kwotę wyraża się w wartości procentowej od całkowitej kwoty kredytu w stosunku rocznym. (Np. Tomek, pożyczając 1000zł na 2 lata musi oddać 1200 zł. Roczna opłata za kredyt wynosi $ 200 / 2 = 100 \text{ zł} $, co jest wartością 10\% z całkowitej pożyczonej kwoty. RRSO wynosi wtedy 10\%).
	\item[Saldo] Stan konta w wybranej walucie/jednostce aktyw (ilość akcji, kruszcu) po uwzględnieniu wszystkich transakcji rozliczonych i nierozliczonych w danej chwili.
...
Od 2010 roku interesuje się tematyką oszczędzania pieniędzy i pomnażania oszczędności. Początkowo starałem się szukać bezpiecznego miejsca dla odłożonych drobniaków w lokatach, które jeszcze przebijały inflację, a lokaty jednodniowe były popularnym sposobem na ominięcie podatku od dochodów kapitałowych. Po kilku lokatach, stwierdziłem, że więcej można zarobić na GPW (Giełdzie Papierów Wartościowych). Szybka lektura nt. inwestowania była dla mnie lekcją pokory. Jeśli zacznę inwestować sam bez poświęcania się całkowicie, stracę wszystkie oszczędności. Inwestowanie w akcje jest obarczone wysokim ryzykiem, wymaga praktyki, wiedzy i ciągłego monitowania sytuacji na rynku. Nie byłem skory do zmiany planów życia by wyciągnąć trochę więcej z moich oszczędności. W trakcie dalszych poszukiwań trafiłem na względnie nowy produkt na polskim rynku. Pożyczki społecznościowe, prosta idea wykorzystująca nadejście ery Web 2.0. Zawartość serwisu tworzą użytkownicy, to użytkownicy pożyczają sobie pieniądze, omijają banki, zarabiają pieniądze na prostym schemacie. Zysk wyższy niż na lokatach bankowych i bardzo niska krzywa nauki urzekły mnie. Już 6 lat pomnażam zaskórniaki z przyzwoitym wynikiem. Wyniki mógłbym uzyskać dużo wyższe, gdybym miał ciągły dostęp do serwisu, tak bym wiedział, że w ciągu ostatnich paru godzin pojawiła się interesująca mnie oferta. Oferta, która znika w ciągu jednego dnia. Nie mogę poświęcić całego dnia na przeglądanie wszystkich ofert. Jednak mogę napisać aplikację mobilną, która poinformuje mnie, gdy nadarzy się okazja godna oderwania mnie od innych obowiązków. Wiem, że również inni inwestorzy często wspominają jak sprzed nosa uciekają im prawdziwe żyły złota, tylko dlatego że nie mają ciągłego dostępu do strumienia informacji. Biorąc pod uwagę zainteresowanie wokół tematu, uważam, że temat mojej pracy inżynierskiej znajduje praktyczne zastosowanie i nie jest sztuką dla sztuki. Projekt z potencjałem do dalszego rozwoju. Wybrałem temat, który mnie interesuje. Instrumenty finansowe. Są bardzo ciekawym i istotnym zagadnieniem. Szczególnie jeśli spojrzy się na nie z szerszej perspektywy. Pryzmat skutków społecznoekonomicznych jakie powodują przez manipulacje. Jedna osoba jest w stanie znacząco zmienić gospodarkę całego kraju operując sporymi ilościami aktywów. Przykładem jest George Soros, który na spekulacjach walutowych wyprowadził ponad 1 miliard funtów brytyjskich.\cite{soros} Ta praca skupia się wokół małej skali małych obrotów pieniężnych na osobę. Ze względu na swój mikro charakter, pożyczki społecznościowe cieszą się moim szczególnym uznaniem. Uważam, że pomagają jednostkom wyjść z problemów ekonomicznych, a w wielu przypadkach urzeczywistniają wizję samodzielnego podnoszenia stopy życia Nie ma elementów zaskoczenia dla pożyczających. Zalet pożyczek opartych na społecznościach jest wiele, przedstawiam je dalej w zestawieniu razem z wadami i ryzykiem inwestycyjnym.
...
Przeanalizowałem rynek aplikacji mobilnych w sklepach: Google Play, App Store Windows Store, Amazon AppStore oraz F-Droid. Znalazłem jedną aktywnie rozwijanych aplikacji wspomagających pożyczki społecznościowe -- Kokoid na androida. Jest to stosunkowo nowa aplikacja (początek 2016 roku), cały czas w fazie testów Konkurencja jednak istnieje w formie aplikacji internetowych. Popularnym narzędziem wspomagającym pożyczkodawców jest www.zndpd.pl czyli ,,Zestaw narzędzi Pożyczkodawców'' Jest to bardzo ogólne narzędzie pozwalające na przeglądanie informacji o aukcjach i pożyczkobiorcach z różnych serwisów, zebrane w jednym miejscu. Ten portal jest nastawiony bardziej na wyświetlanie statystyk i generowanie raportów o własnych inwestycjach. Nie dostrzegłem żadnych aplikacji o podobnej tematyce (przynajmniej na polskim rynku), na których mógłbym się wzorować. Dlatego większość zaimplementowanych funkcjonalności to pomysły nowe, gotowe do przetestowania poza środowiskiem deweloperskim.

\section*{Aplikacja mobilna vs aplikacja webowa}
\addcontentsline{toc}{section}{Aplikacja mobilna vs aplikacja webowa}

Uniwersalnym rozwiązaniem jest przedstawienie narzędzi w formie aplikacji internetowej i podpięcie pod API, konkretnych endpointów w postaci natywnych aplikacji na każdą platformę, bądź wygenerowanie responsywnej strony, na której każdy niezależnie od platformy mógłby korzystać z udostępnionych narzędzi. Ta idea jest zbyt utopijna na jednoosobowy projekt, do zrealizowania go potrzeba specjalisty od każdej popularnej platformy mobilnej, web developera oraz architekta, który to wszystko podzieli na działające komponenty. Najlepszym zrealizowaniem pomysłu staje się aplikacja mobilna pod system Windows Phone. Zdecydowanie przeważające czynniki: zajęcia z programowania Windows Phone, znajomość platformy .NET, brak doświadczenia z tworzeniem front endu z wykorzystaniem HTML’a.
...
Na polskim rynku nie istnieje żadne rozwiązanie pozwalające na połączenie mobilnego świata z rynkiem pożyczek. Stres związany z brakiem natychmiastowego dostępu do własnych inwestycji jest ogromny, gdy podejmuje się decyzje pod presją czasu. Poszukiwanie nowych możliwości na telefonie jest bardzo niewygodne i wymaga wiele cierpliwości, żeby opanować stare, nieresponsywne serwisy na małym ekranie. Instytucje finansowe zbyt długo zwlekają z wprowadzeniem mobilnych rozwiązań. Jako inwestor wziąłem sprawy we własne ręce i stworzyłem aplikacje mobilną. Teraz wystarczy posiadać urządzenie wyposażone w system operacyjny Windows Phone 8.1 lub nowszym, by móc cieszyć się dostępem do najnowszych okazji pożyczkowych gdziekolwiek istnieje zasięg telefonii komórkowej. Uważam, że to narzędzie spopularyzuje Windows Phone, jako platformę, na którą jednak pisze się jakieś aplikacje.
...
\item \textbf{Windykacje}. Jak wygląda odzyskiwanie wierzytelności przy braku spłat? Pierwszą rzeczą, którą należy zrobić to próbować rozmowy z wierzycielem, wyjaśnić przyczyny opóźnień i znaleźć sposób na najszybszy powrót do regularnych spłat. Jeśli kontaktu nie można nawiązać natychmiast, można skorzystać z monitów udostępnianych w serwisach. Są one bezpośrednio na stronie z ofertą pożyczkową. Wysłanie monitu, jest przypomnieniem w formie SMS/telefonu/emaila o zalegających ratach, monit stanowi dodatkowe obciążenie finansowe dla spłacającego, dlatego nie zalecam stosować tego rozwiązania na początek. Kolejnym krokiem jest podjęcie działań prawnych, tu zaczynają się problemy dla inwestora, gdyż należy zdecydować czy ściągać samodzielnie, wynająć własną firmę prawniczą, czy skorzystać z usług dostępnych w serwisie. Jako drobny inwestor, przy kwotach 100--500 zł najoptymalniejszym rozwiązaniem jest wybór ścieżki od kontaktu z PB do monitów. Jeśli nie można dojść swoich roszczeń polubownie, dobrym rozwiązaniem jest wspólna windykacja większości PD aukcji. Inwestorzy wspólnie wynajmują firmę windykacyjną, gdzie za 10-15\% odzyskanej kwoty, można liczyć na większe prawdopodobieństwo odzyskania pieniędzy. Jeśli firma nie odzyska długu, nie dostaje wynagrodzenia.
...
Maksymalne oprocentowanie dla pożyczki w skali roku wynosi stawka stopy lombardowej pomnożona razy cztery. Średnie oprocentowanie w serwisie jest wyższe niż 10\%, ponieważ jest liczone od czasu powstania serwisu, kiedy to stawka lombardowa wynosiła 6,25\% co dawało profity do 25\% rocznie. Stawka oprocentowania rośnie również kiedy pożyczka jest spłacana przed czasem (jest to możliwe, szczególnie, kiedy PB buduje swoją reputację i zobowiązuje się spłacić 3 letnie zobowiązanie w ciągu 1 roku). Z moich osobistych obserwacji wyłania się obraz zwrotu z inwestycji na poziomie 12\% rocznie łącznie z niespłacalnymi zobowiązaniami. W tą cenę należy wliczyć również czas poświęcony na analizę i pilnowanie inwestycji, kontakt z pożyczkobiorcą i innymi wpłacającymi. Opłacalność (gdzie zysk przekracza zainwestowany czas) można zaobserwować przy kwotach inwestycji przekraczających 500 zł miesięcznie. Utrzymywanie się z odsetek na serwisie wymaga przejścia na etat by zarządzać setkami pożyczek (tu można zająć się inwestowaniem w akcje).
...
W porównaniu brakuje serwisu Lendico. Ten niemiecki serwis zawiesił działalność inwestycyjną, od kilku miesięcy nie ma ofert inwestycyjnych. Prawdopodobnie zostanie wycofany z polskiego rynku.
