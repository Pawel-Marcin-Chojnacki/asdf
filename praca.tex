...
Przeanalizowałem rynek aplikacji mobilnych w sklepach: Google Play, App Store Windows Store, Amazon AppStore oraz F-Droid. Znalazłem tylko jedną aktywnie rozwijaną aplikację wspomagającą pożyczki społecznościowe -- Kokoid na androida. Jest to nowa aplikacja (z początu 2016 roku), cały czas w fazie testów. Oprogramowanie wspomagające inwestycje istnieje głównie w formie aplikacji internetowych. Popularnym narzędziem wspomagającym pożyczkodawców jest www.zndpd.pl czyli ,,Zestaw narzędzi Pożyczkodawców'' Jest to rozbudowane narzędzie umożliwiające przeglądanie informacji o aukcjach, pożyczkobiorcach i statystykach spłacalności z różnych serwisów. Wszystkie dane zebrane są jednym miejscu w formie strony z raportem. Ten portal jest nastawiony bardziej na wyświetlanie statystyk i generowanie raportów o własnych inwestycjach. Nie dostrzegłem żadnych aplikacji o podobnej tematyce (przynajmniej na polskim rynku), na których mógłbym się wzorować. Dlatego większość zaimplementowanych funkcjonalności to pomysły nowe, gotowe do przetestowania poza środowiskiem deweloperskim.
